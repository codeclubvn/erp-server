...
type (
	ERPCategoryService interface {
		...
		GetList(ctx context.Context, req erpdto.GetListCategoryRequest) ([]*models.CategoryResult, int64, error)
	}
...
func (u *categoryService) GetList(ctx context.Context, req erpdto.GetListCategoryRequest) ([]*models.CategoryResult, int64, error) {
