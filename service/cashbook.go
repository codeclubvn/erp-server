...
type CashbookService interface {
	Create(ctx context.Context, req erpdto.CreateCashbookRequest) (*models.Cashbook, error)
	Update(ctx context.Context, req erpdto.UpdateCashbookRequest) (*models.Cashbook, error)
	GetList(ctx context.Context, req erpdto.ListCashbookRequest) ([]*models.Cashbook, int64, error)
	GetListDebt(ctx context.Context, req erpdto.ListCashbookRequest) ([]*models.Cashbook, int64, error)
	Delete(ctx context.Context, transactionID string) error
	GetCashbookByOrderId(tx *repository.TX, ctx context.Context, orderId string) (*models.Cashbook, error)
	GetOne(ctx context.Context, id string) (*models.Cashbook, error)
}
...
func (s *cashbookService) Create(ctx context.Context, req erpdto.CreateCashbookRequest) (*models.Cashbook, error) {
	output := &models.Cashbook{}
...
func (s *cashbookService) Update(ctx context.Context, req erpdto.UpdateCashbookRequest) (*models.Cashbook, error) {
...
func (s *cashbookService) GetList(ctx context.Context, req erpdto.ListCashbookRequest) ([]*models.Cashbook, int64, error) {
	return s.cashbookRepo.GetList(ctx, req)
}

func (s *cashbookService) GetListDebt(ctx context.Context, req erpdto.ListCashbookRequest) ([]*models.Cashbook, int64, error) {
	return s.cashbookRepo.GetListDebt(ctx, req)
}

func (s *cashbookService) GetOne(ctx context.Context, id string) (*models.Cashbook, error) {
	return s.cashbookRepo.GetOneById(ctx, id)
}

func (s *cashbookService) GetCashbookByOrderId(tx *repository.TX, ctx context.Context, orderId string) (*models.Cashbook, error) {
