...
type CashbookRepository interface {
	Create(tx *TX, ctx context.Context, input *models.Cashbook) error
	Update(tx *TX, ctx context.Context, input *models.Cashbook) error
	Delete(tx *TX, ctx context.Context, id string) error
	GetOneById(ctx context.Context, id string) (*models.Cashbook, error)
	GetCashbookByOrderId(tx *TX, ctx context.Context, orderId string) (*models.Cashbook, error)
	GetDebtByOrderId(tx *TX, ctx context.Context, orderId string) (*models.Cashbook, error)
	GetList(ctx context.Context, req erpdto.ListCashbookRequest) (res []*models.Cashbook, total int64, err error)
...
func (r *transactionRepo) Create(tx *TX, ctx context.Context, input *models.Cashbook) error {
	tx = GetTX(tx, *r.db)
	return tx.db.WithContext(ctx).Create(input).Error
}

func (r *transactionRepo) GetOneById(ctx context.Context, id string) (*models.Cashbook, error) {
	input := &models.Cashbook{}
...
func (r *transactionRepo) GetCashbookByOrderId(tx *TX, ctx context.Context, orderId string) (*models.Cashbook, error) {
	tx = GetTX(tx, *r.db)
	input := &models.Cashbook{}
...
func (r *transactionRepo) GetDebtByOrderId(tx *TX, ctx context.Context, orderId string) (*models.Cashbook, error) {
	tx = GetTX(tx, *r.db)
	input := &models.Cashbook{}
	err := tx.db.WithContext(ctx).Where("order_id = ?", orderId).
		Joins("left join cashbook_categories on cashbook_categories.id = cashbooks.cashbook_category_id").
...
func (r *transactionRepo) GetList(ctx context.Context, req erpdto.ListCashbookRequest) (res []*models.Cashbook, total int64, err error) {
	query := r.db.Model(&models.Cashbook{})
	if req.Search != "" {
...
func (r *transactionRepo) GetListDebt(ctx context.Context, req erpdto.ListCashbookRequest) (res []*models.Cashbook, total int64, err error) {
	query := r.db.Model(&models.Cashbook{}).Debug().
		Joins("left join cashbook_categories on cashbook_categories.id = cashbooks.cashbook_category_id").
		Where("cashbook_categories.type in (?)", []string{"debt", "loan"})
	if req.Search != "" {
		query = query.Where("name ilike ?", "%"+req.Search+"%")
...
func (r *transactionRepo) Update(tx *TX, ctx context.Context, input *models.Cashbook) error {
	tx = GetTX(tx, *r.db)
...
func (r *transactionRepo) Delete(tx *TX, ctx context.Context, id string) error {
	tx = GetTX(tx, *r.db)
	return tx.db.WithContext(ctx).Where("id = ?", id).Delete(&models.Cashbook{}).Error
}
...
func (r *transactionRepo) GetTotalTransactionByCategoryIdAndTime(ctx context.Context, categoryId uuid.UUID, startTime, endTime *time.Time) (total float64, err error) {
	query := r.db.Model(&models.Cashbook{}).Where("cashbook_category_id = ?", categoryId)
	if startTime != nil {
